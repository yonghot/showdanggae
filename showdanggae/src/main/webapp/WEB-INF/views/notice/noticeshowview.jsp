...
function deleteForm(){
	...
	<div class="col-md-7">
		...
		<div class="col-sm-10 col-sm-offset-2 text-center">
			<input type="button" value="목록" onclick="sendList()"class="btn btn-info btn-lg">
			
	 <c:if test="${!empty sessionScope.managerlogin}">
		<input type="button" value="수정" onclick="updateForm()" class="btn btn-info btn-lg">
		<input type="button" value="삭제" onclick="deleteForm()" class="btn btn-info btn-lg">
		</c:if>

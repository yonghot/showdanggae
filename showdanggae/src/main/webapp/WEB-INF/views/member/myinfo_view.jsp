                            ...
                            <form class="form-horizontal text-left" role="form" action="updateMember.do">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-10 col-sm-offset-2 text-left">
                                        <button type="submit" class="btn btn-info btn-lg" id="subBtn">수정</button>
                                        <button type="button" class="btn btn-default btn-lg" id="canBtn">취소</button>
                                         <button type="button" class="btn btn-default btn-lg" id="withdrawBtn">탈퇴</button>
